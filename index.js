...
function computePortions() {
    if (amount.value && income1.value && income2.value) {
        ...
        document.getElementById('portion1').innerHTML = '$' + ((income1.value / total) * amount.value).toString();
        document.getElementById('portion2').innerHTML = '$' + ((income2.value / total) * amount.value).toString();        
    }
